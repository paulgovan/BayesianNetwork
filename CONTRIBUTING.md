...
This outlines how to propose a change to BayesianNetwork. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("paulgovan/BayesianNetwork", fork = TRUE)`.
...
[Contributor Code of
Conduct](http://paulgovan.github.io/BayesianNetwork/CODE_OF_CONDUCT.md).
